...
public class BooksStepDefs extends BaseStep {
    ...
    public void book_information_must_match_the_database_for_The_kite_runner(String book) {
        ...
        assertEquals("author did not match", dbData.get("author").toString(), pages.booksPage().author.getAttribute("value"));
        assertEquals("year did not match", dbData.get("year").toString(), pages.booksPage().year.getAttribute("value"));
        assertEquals("isbn did not match", dbData.get("isbn").toString(), pages.booksPage().isbn.getAttribute("value"));
        assertEquals("description did not match", dbData.get("description").toString(), pages.booksPage().description.getAttribute("value"));
        assertEquals("category did not match", dbData.get("name").toString(), pages.booksPage().categoryList().getFirstSelectedOption().getText());
    }
